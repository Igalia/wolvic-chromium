...
using extensions::FunctionFromString;
using extensions::Message;
using extensions::MessageTarget;
using extensions::MessagingEndpoint;
using extensions::NativeExtensionBindingsSystemUnittest;
using extensions::NativeRendererMessagingService;
using extensions::PortId;
using extensions::RuntimeHooksDelegate;
using extensions::RunFunction;
using extensions::RunFunctionAndExpectError;
using extensions::RunFunctionOnGlobal;
using extensions::ScriptContext;
using extensions::SendMessageTester;
using extensions::V8ToString;
using extensions::V8ValueFromScriptSource;
