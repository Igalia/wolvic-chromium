...
using extensions::GetStringPropertyFromObject;
using extensions::GetValueAs;
...
using IdentityHooksDelegateTest = extensions::NativeExtensionBindingsSystemUnittest;
