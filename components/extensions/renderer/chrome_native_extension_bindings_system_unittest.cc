...
using extensions::GetPropertyFromObject;
...
using extensions::SetCurrentDeveloperMode;
...
TEST_F(NativeExtensionBindingsSystemUnittest,
  ...
  SetCurrentDeveloperMode(extensions::kRendererProfileId, true);
...
TEST_F(NativeExtensionBindingsSystemUnittest,
  ...
  SetCurrentDeveloperMode(extensions::kRendererProfileId, false);
