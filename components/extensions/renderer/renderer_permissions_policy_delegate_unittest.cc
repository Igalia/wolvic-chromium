...
using extensions::ExtensionsRendererAPIProvider;
using extensions::ExtensionsRendererClient;
using extensions::Dispatcher;
using extensions::RendererExtensionRegistry;
using extensions::TestExtensionsRendererClient;

// mshin: Block anonymous namespace for a forward declation with
// components_extensions namespace in dispatcher.h
// namespace {
