...
#ifndef COMPONENTS_EXTENSIONS_RENDERER_RESOURCE_REQUEST_POLICY_H_
#define COMPONENTS_EXTENSIONS_RENDERER_RESOURCE_REQUEST_POLICY_H_
...
class ResourceRequestPolicy {
 public:
  explicit ResourceRequestPolicy(extensions::Dispatcher* dispatcher);
  ...
  void OnExtensionUnloaded(const extensions::ExtensionId& extension);
 ...
 private:
  ...
  using WebAccessibleHostMap =
      std::map<extensions::ExtensionId, extensions::ExtensionGuid>;
  WebAccessibleHostMap web_accessible_resources_map_;
};

}  // namespace components_extensions

#endif  // COMPONENTS_EXTENSIONS_RENDERER_RESOURCE_REQUEST_POLICY_H_
