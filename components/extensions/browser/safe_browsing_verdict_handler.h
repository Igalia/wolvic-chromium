...
class SafeBrowsingVerdictHandler : public extensions::ExtensionRegistryObserver {
 public:
  SafeBrowsingVerdictHandler(extensions::ExtensionPrefs* extension_prefs,
 ...
 private:
  ...
  void UpdateBlocklistedExtensions(const extensions::ExtensionIdSet& blocklist,
  ...
  // Browsing while extensions::ExtensionRegistry::blocklisted_extensions_ contains
  // extensions blocklisted by other sources such as Omaha attribute.
  extensions::ExtensionSet blocklist_;
