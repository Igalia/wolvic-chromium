...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_INSTALL_TRACKER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_INSTALL_TRACKER_H_
...
class InstallTracker : public KeyedService, public extensions::ExtensionRegistryObserver {
 public:
  ...
  // page.
  void OnAppsReordered(const std::optional<extensions::ExtensionId>& extension_id);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_INSTALL_TRACKER_H_
