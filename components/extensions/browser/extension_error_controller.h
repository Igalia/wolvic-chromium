...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_CONTROLLER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_CONTROLLER_H_
...
class ExtensionErrorController : public ExtensionErrorUI::Delegate {
 ...
 private:
  ...
  extensions::ExtensionSet blocklisted_extensions_;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_CONTROLLER_H_
