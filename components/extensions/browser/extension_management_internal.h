...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_INTERNAL_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_INTERNAL_H_
...
struct IndividualSettings {
  ...
  extensions::APIPermissionSet blocked_permissions;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_INTERNAL_H_
