...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALLER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALLER_H_
...
class WebstoreInstaller : public extensions::ExtensionRegistryObserver,
 ...
 public:
  ...
  struct Approval : public base::SupportsUserData::Data {
    static std::unique_ptr<Approval> CreateWithInstallPrompt(
        content::BrowserContext* browser_context);

    // Creates an Approval for installing a shared module.
    static std::unique_ptr<Approval> CreateForSharedModule(
        content::BrowserContext* browser_context);
    ...
    // The browser_context the extension should be installed into.
 ...
 private:
  ...
  void OnInstallerDone(const std::optional<extensions::CrxInstallError>& error);
  ...
  // Pending modules.
  std::list<extensions::SharedModuleInfo::ImportInfo> pending_modules_;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALLER_H_
