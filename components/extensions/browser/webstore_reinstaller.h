...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_REINSTALLER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_REINSTALLER_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_REINSTALLER_H_
