...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_TEST_UTIL_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_TEST_UTIL_H_
...
class ExtensionManagementPrefUpdaterBase {
 public:
  ...
  void UnsetPerExtensionSettings(const extensions::ExtensionId& id);
  void ClearPerExtensionSettings(const extensions::ExtensionId& id);
  ...
  void SetIndividualExtensionInstallationAllowed(const extensions::ExtensionId& id,
                                                 bool allowed);
  void SetIndividualExtensionAutoInstalled(const extensions::ExtensionId& id,
  ...
  // |id| is extension ID.
  void SetBlockedInstallMessage(const extensions::ExtensionId& id,
 ...
 public:
  explicit ExtensionManagementPrefUpdater(TestingPrefService* service)
    ...
    const base::Value* pref_value =
        service_->GetManagedPref(extensions::pref_names::kExtensionManagement);
  ...
  ~ExtensionManagementPrefUpdater() override {
    service_->SetManagedPref(extensions::pref_names::kExtensionManagement,
                             base::Value(TakePref()));
  }
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_TEST_UTIL_H_
