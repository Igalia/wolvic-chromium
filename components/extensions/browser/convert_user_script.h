...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_CONVERT_USER_SCRIPT_H_
#define COMPONENTS_EXTENSIONS_BROWSER_CONVERT_USER_SCRIPT_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_CONVERT_USER_SCRIPT_H_
