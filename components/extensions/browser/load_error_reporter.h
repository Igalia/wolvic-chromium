...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_LOAD_ERROR_REPORTER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_LOAD_ERROR_REPORTER_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_LOAD_ERROR_REPORTER_H_
