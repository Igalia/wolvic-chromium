...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_UI_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_UI_H_
 ...
 public:
  class Delegate {
   public:
    ...
    virtual const extensions::ExtensionSet& GetBlocklistedExtensions() = 0;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_ERROR_UI_H_
