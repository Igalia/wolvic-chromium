...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_CWS_INFO_SERVICE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_CWS_INFO_SERVICE_H_
...
class CWSInfoServiceInterface {
 public:
  ...
  virtual std::optional<bool> IsLiveInCWS(const extensions::Extension& extension) const = 0;
...
class CWSInfoService : public CWSInfoServiceInterface, public KeyedService {
 public:
  // Convenience method to get the service for a browser context.
  static CWSInfoService* Get(content::BrowserContext* browser_context);
  ...
  std::optional<bool> IsLiveInCWS(const extensions::Extension& extension) const override;
  std::optional<CWSInfo> GetCWSInfo(const extensions::Extension& extension) const override;
 ...
 protected:
  ...
  const raw_ptr<extensions::ExtensionPrefs> extension_prefs_ = nullptr;
  const raw_ptr<extensions::ExtensionRegistry> extension_registry_ = nullptr;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_CWS_INFO_SERVICE_H_
