...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_SERVICE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_SERVICE_H_
...
class ExtensionServiceInterface {
 public:
  ...
  virtual void AddComponentExtension(const extensions::Extension* extension) = 0;
...
class ExtensionService : public ExtensionServiceInterface,
 ...
 public:
  // Constructor stores pointers to |browser_context| and |extension_prefs| but
  // ownership remains at caller.
  ExtensionService(content::BrowserContext* browser_context,
  ...
  void OnExternalProviderUpdateComplete(
      ...
      const std::vector<extensions::ExternalInstallInfoFile>& external_file_extensions,
  ...
  void OnUnpackedReloadFailure(const extensions::Extension* extension,
  ...
  void OnGreylistStateAdded(const std::string& extension_id,
                            extensions::BitMapBlocklistState new_state);
  ...
  // extension.
  void GrantPermissionsAndEnableExtension(const extensions::Extension* extension);
  ...
  void OnExtensionInstalled(const extensions::Extension* extension,
                            ...
                            int install_flags,
                            const extensions::declarative_net_request::RulesetInstallPrefs&
  ...
  void DidCreateMainFrameForBackgroundPage(extensions::ExtensionHost* host);
  ...
  const extensions::ExtensionSet* delayed_installs() const { return &delayed_installs_; }
 ...
 private:
  ...
  raw_ptr<extensions::ExtensionSystem, AcrossTasksDanglingUntriaged> system_ = nullptr;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_SERVICE_H_
