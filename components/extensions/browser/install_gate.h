...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_INSTALL_GATE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_INSTALL_GATE_H_
...
class InstallGate {
 public:
  ...
  virtual Action ShouldDelay(const extensions::Extension* extension,
                             bool install_immediately) = 0;
};

}  // namespace components_extensions

#endif  // COMPONENTS_EXTENSIONS_BROWSER_INSTALL_GATE_H_
