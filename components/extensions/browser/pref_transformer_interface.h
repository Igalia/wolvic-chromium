...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_PREF_TRANSFORMER_INTERFACE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_PREF_TRANSFORMER_INTERFACE_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_PREF_TRANSFORMER_INTERFACE_H_
