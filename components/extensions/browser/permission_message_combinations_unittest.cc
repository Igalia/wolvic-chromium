...
// Disable a test since not support bluetooth Platform APIs
...
TEST_F(PermissionMessageCombinationsUnittest, DISABLED_USBSerialBluetoothCoalescing) {
...
TEST_F(PermissionMessageCombinationsUnittest,
       DISABLED_MediaGalleriesPermissionMessages) {
  CreateAndInstall(
      "{"
      "  'app': {"
      "    'background': {"
...
// Disable the test since NOT support the syncFileSystem platform API
...
TEST_F(PermissionMessageCombinationsUnittest, DISABLED_PermissionMessageCombos) {
  CreateAndInstall(
      "{"
      "  'permissions': ["
      "    'tabs',"
