...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_STATE_FETCHER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_STATE_FETCHER_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_STATE_FETCHER_H_
