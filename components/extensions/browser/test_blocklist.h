...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_H_
#define COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_H_
...
class BlocklistStateFetcherMock : public BlocklistStateFetcher {
 public:
  ...
  void SetState(const std::string& id, extensions::BlocklistState state);
 ...
 private:
  std::map<std::string, extensions::BlocklistState> states_;
  int request_count_;
};
...
class TestBlocklist {
 public:
  ...
  extensions::BlocklistState GetBlocklistState(const std::string& extension_id);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_TEST_BLOCKLIST_H_
