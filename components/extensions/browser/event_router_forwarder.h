...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EVENT_ROUTER_FORWARDER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EVENT_ROUTER_FORWARDER_H_
...
//   thread.
// - the class treats BrowserContext as a single profile.
class EventRouterForwarder
 ...
 public:
  ...
  void DispatchEventToRenderers(extensions::events::HistogramValue histogram_value,
                                const std::string& event_name,
                                base::Value::List event_args,
 ...
 protected:
  ...
  // Virtual for testing.
  virtual void HandleEvent(const extensions::ExtensionId& extension_id,
  ...
  // Virtual for testing.
  virtual void CallEventRouter(content::BrowserContext* browser_context,
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_EVENT_ROUTER_FORWARDER_H_
