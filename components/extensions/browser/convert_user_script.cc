...
using extensions::UserScriptLoader;
...
scoped_refptr<Extension> ConvertUserScriptToExtension(
  ...
  content_script.run_at = extensions::ConvertRunLocationForAPI(script.run_location());
  ...
  base::FilePath manifest_path = temp_dir.GetPath().Append(extensions::kManifestFilename);
