...
using components_extensions::InstallObserver;
...
class InstallTrackerTest : public testing::Test {
 public:
  InstallTrackerTest() {
    ...
    tracker_ = base::WrapUnique(new InstallTracker(browser_context_.get(), nullptr));
  }
...
// TODO(mshin): Enable the below tests after migrating ScopedActiveInstall
// Verifies that active installs are registered and deregistered correctly
