...
bool IndividualSettings::Parse(const base::Value::Dict& dict,
  ...
  extensions::APIPermissionSet parsed_blocked_permissions;
  extensions::APIPermissionSet explicitly_allowed_permissions;
  const base::Value::List* list_value =
      dict.FindList(schema_constants::kAllowedPermissions);
  if (list_value) {
    if (!extensions::APIPermissionSet::ParseFromJSON(
            *list_value, extensions::APIPermissionSet::kDisallowInternalPermissions,
  ...
  extensions::APIPermissionSet::Difference(parsed_blocked_permissions,
  ...
  auto parse_url_pattern_set = [](const base::Value::Dict& dict,
                                  const char key[], extensions::URLPatternSet* out_value) {
