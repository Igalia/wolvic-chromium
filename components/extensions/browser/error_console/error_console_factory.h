...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_ERROR_CONSOLE_ERROR_CONSOLE_FACTORY_H_
#define COMPONENTS_EXTENSIONS_BROWSER_ERROR_CONSOLE_ERROR_CONSOLE_FACTORY_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_ERROR_CONSOLE_ERROR_CONSOLE_FACTORY_H_
