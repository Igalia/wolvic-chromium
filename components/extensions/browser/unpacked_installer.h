...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_UNPACKED_INSTALLER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_UNPACKED_INSTALLER_H_
...
class UnpackedInstaller
 ...
 public:
  using CompletionCallback = base::OnceCallback<void(const extensions::Extension* extension,
                                                     const base::FilePath&,
                                                     const std::string&)>;
 ...
 private:
  ...
  bool LoadExtension(extensions::mojom::ManifestLocation location,
                     int flags,
                     std::string* error);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_UNPACKED_INSTALLER_H_
