...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_SCOPED_ACTIVE_INSTALL_H_
#define COMPONENTS_EXTENSIONS_BROWSER_SCOPED_ACTIVE_INSTALL_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_SCOPED_ACTIVE_INSTALL_H_
