...
#include "components/extensions/browser/api/braille_display_private/braille_display_private_api.h"
...
class BrailleDisplayPrivateAPI::DefaultEventDelegate
 ...
 public:
  DefaultEventDelegate(EventRouter::Observer* observer, content::BrowserContext* context);
...
BrailleDisplayPrivateAPI::BrailleDisplayPrivateAPI(
    ...
    : browser_context_(context),
      event_delegate_(new DefaultEventDelegate(this, browser_context_)) {}
...
BrailleDisplayPrivateAPI::DefaultEventDelegate::DefaultEventDelegate(
    EventRouter::Observer* observer, content::BrowserContext* context)
    : observer_(observer), browser_context_(context) {
...
BrailleDisplayPrivateAPI::DefaultEventDelegate::~DefaultEventDelegate() {
  EventRouter::Get(browser_context_)->UnregisterObserver(observer_);
}
