...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_CONTEXT_MENUS_CONTEXT_MENUS_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_CONTEXT_MENUS_CONTEXT_MENUS_API_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_CONTEXT_MENUS_CONTEXT_MENUS_API_H_
