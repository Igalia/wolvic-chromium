...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_OMNIBOX_OMNIBOX_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_OMNIBOX_OMNIBOX_API_H_
...
class ExtensionOmniboxEventRouter {
 public:
  ...
  static void OnInputStarted(content::BrowserContext* context, const ExtensionId& extension_id);
  ...
  static bool OnInputChanged(content::BrowserContext* context,
  ...
  static void OnInputCancelled(content::BrowserContext* context,
                               const ExtensionId& extension_id);

  // The user has deleted an extension omnibox suggestion result.
  static void OnDeleteSuggestion(content::BrowserContext* context,
                                 const ExtensionId& extension_id,
...
class OmniboxAPI : public BrowserContextKeyedAPI,
 ...
 private:
  ...
  // TODO(mshin): Enable the below code after migrating ExtensionIconManager
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_OMNIBOX_OMNIBOX_API_H_
