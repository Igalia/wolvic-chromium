...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_MODULE_MODULE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_MODULE_MODULE_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_MODULE_MODULE_H_
