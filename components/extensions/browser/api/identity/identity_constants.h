...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_IDENTITY_IDENTITY_CONSTANTS_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_IDENTITY_IDENTITY_CONSTANTS_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_IDENTITY_IDENTITY_CONSTANTS_H_
