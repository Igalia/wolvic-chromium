...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_DEVELOPER_PRIVATE_DEVELOPER_PRIVATE_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_DEVELOPER_PRIVATE_DEVELOPER_PRIVATE_API_H_
...
class DeveloperPrivateEventRouter : public ExtensionRegistryObserver/*,
 ...
 public:
  explicit DeveloperPrivateEventRouter(content::BrowserContext* context);
...
class DeveloperPrivateGetExtensionsInfoFunction
 ...
 private:
  ...
  void OnInfosGenerated(
      std::vector<api::developer_private::ExtensionInfo> infos);
// TODO(mshin): Enable the below code after migrating ExtensionInfoGenerator
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_DEVELOPER_PRIVATE_DEVELOPER_PRIVATE_API_H_
