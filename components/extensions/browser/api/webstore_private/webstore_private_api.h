...
class WebstorePrivateApi {
 public:
  class Delegate {
   public:
    ...
    virtual void OnExtensionInstallFailure(
        ...
        components_extensions::WebstoreInstaller::FailureReason reason) {}
  };
  ...
  static std::unique_ptr<components_extensions::WebstoreInstaller::Approval>
  PopApprovalForTesting(content::BrowserContext* browser_context,
...
class WebstorePrivateBeginInstallWithManifest3Function
    : public ExtensionFunction,
      public components_extensions::WebstoreInstallHelper::Delegate {
 public:
 ...
 private:
  ...
  std::unique_ptr<components_extensions::ScopedActiveInstall> scoped_active_install_;
...
class WebstorePrivateCompleteInstallFunction : public ExtensionFunction {
 ...
 private:
  ...
  std::unique_ptr<components_extensions::WebstoreInstaller::Approval> approval_;
  std::unique_ptr<components_extensions::ScopedActiveInstall> scoped_active_install_;
