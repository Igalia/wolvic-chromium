...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_BOOKMARKS_BOOKMARKS_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_BOOKMARKS_BOOKMARKS_API_H_
...
class BookmarkEventRouter : public bookmarks::BookmarkModelObserver {
 public:
  explicit BookmarkEventRouter(content::BrowserContext* browser_context);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_BOOKMARKS_BOOKMARKS_API_H_
