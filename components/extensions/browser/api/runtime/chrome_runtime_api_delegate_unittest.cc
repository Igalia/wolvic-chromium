...
#include "components/extensions/browser/api/runtime/chrome_runtime_api_delegate.h"
...
using extensions::ExtensionDownloaderTask;
using extensions::ExtensionDownloaderTestDelegate;
using extensions::ExtensionId;
using extensions::ExtensionPrefs;
using extensions::ExtensionRegistry;
using extensions::ExtensionRegistryObserver;
using extensions::ExtensionSystem;
using extensions::GetTestVerifierFormat;
...
class ChromeRuntimeAPIDelegateTest : public ExtensionServiceTestWithInstall {
 public:
  ...
  void SetUp() override {
    ...
    //     std::make_unique<UpdateInstallGate>(service()->browser_context());
...
// TODO(mshin) Enable the bewow test after migrating UpdateInstallGate
TEST_F(ChromeRuntimeAPIDelegateTest, DISABLED_RequestUpdateCheck) {
