...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_IDLTEST_IDLTEST_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_IDLTEST_IDLTEST_API_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_IDLTEST_IDLTEST_API_H_
