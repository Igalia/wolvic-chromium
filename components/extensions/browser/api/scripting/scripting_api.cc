...
#include "components/extensions/browser/api/scripting/scripting_api.h"
...
bool CanAccessTarget(const PermissionsData& permissions,
  ...
  // TODO(mshin): Enable the below code after migrating ExtensionTabUtil & TabHelper
  ...
  ScriptExecutor* script_executor = nullptr;// tab_helper->script_executor();
