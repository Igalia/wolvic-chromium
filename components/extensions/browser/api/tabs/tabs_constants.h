...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_CONSTANTS_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_CONSTANTS_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_CONSTANTS_H_
