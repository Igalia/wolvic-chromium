...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_API_H_
...
class TabsCaptureVisibleTabFunction
 ...
 public:
  ...
  ResponseAction Run() override;
  void GetQuotaLimitHeuristics(extensions::QuotaLimitHeuristics* heuristics) const override;
 ...
 private:
  // TODO(mshin): Enable the below code after migrating ChromeExtensionFunctionDetails
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_TABS_TABS_API_H_
