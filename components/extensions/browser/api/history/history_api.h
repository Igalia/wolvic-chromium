...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_HISTORY_HISTORY_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_HISTORY_HISTORY_API_H_
...
#include "components/extensions/common/api/history.h"
...
class HistoryEventRouter : public history::HistoryServiceObserver {
 public:
  HistoryEventRouter(content::BrowserContext* browser_context,
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_HISTORY_HISTORY_API_H_
