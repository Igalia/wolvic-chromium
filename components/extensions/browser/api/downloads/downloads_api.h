...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_DOWNLOADS_DOWNLOADS_API_H_
#define COMPONENTS_EXTENSIONS_BROWSER_API_DOWNLOADS_DOWNLOADS_API_H_
...
class ExtensionDownloadsEventRouter
 ...
 public:
  ...
  explicit ExtensionDownloadsEventRouter(
      content::BrowserContext* browser_context, content::DownloadManager* manager);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_DOWNLOADS_DOWNLOADS_API_H_
