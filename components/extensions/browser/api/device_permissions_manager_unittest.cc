...
using extensions::DevicePermissions;
using extensions::DevicePermissionsManager;
using extensions::DevicePermissionEntry;
using extensions::HidDeviceManager;
...
class DevicePermissionsManagerTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    UsbDeviceManager::Get(env_->browser_context())
    ...
    HidDeviceManager::Get(env_->browser_context())->LazyInitialize();
    base::RunLoop().RunUntilIdle();
...
TEST_F(DevicePermissionsManagerTest, AllowAndClearDevices) {
  DevicePermissionsManager* manager =
      DevicePermissionsManager::Get(env_->browser_context());
