...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSION_ID_H__
#define COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSION_ID_H__
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSION_ID_H__
