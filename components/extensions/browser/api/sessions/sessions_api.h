...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSIONS_API_H__
#define COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSIONS_API_H__

#include <string>

#include "base/memory/raw_ptr.h"
#include "components/extensions/common/api/sessions.h"
#include "components/extensions/common/api/tab_groups.h"
...
class SessionsEventRouter : public sessions::TabRestoreServiceObserver {
 public:
  explicit SessionsEventRouter(content::BrowserContext* context);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_API_SESSIONS_SESSIONS_API_H__
