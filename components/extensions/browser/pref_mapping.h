...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_PREF_MAPPING_H_
#define COMPONENTS_EXTENSIONS_BROWSER_PREF_MAPPING_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_PREF_MAPPING_H_
