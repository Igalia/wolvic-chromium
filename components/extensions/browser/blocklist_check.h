...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_BLOCKLIST_CHECK_H_
#define COMPONENTS_EXTENSIONS_BROWSER_BLOCKLIST_CHECK_H_
...
class BlocklistCheck : public extensions::PreloadCheck {
 public:
 ...
 private:
  void OnBlocklistedStateRetrieved(extensions::BlocklistState blocklist_state);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_BLOCKLIST_CHECK_H_
