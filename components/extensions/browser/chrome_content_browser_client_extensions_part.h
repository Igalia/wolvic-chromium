...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_CHROME_CONTENT_BROWSER_CLIENT_EXTENSIONS_PART_H_
#define COMPONENTS_EXTENSIONS_BROWSER_CHROME_CONTENT_BROWSER_CLIENT_EXTENSIONS_PART_H_
...
class ChromeContentBrowserClientExtensionsPart {
 public:
  ...
  static GURL GetEffectiveURL(content::BrowserContext* browser_context, const GURL& url);
  ...
  static bool ShouldUseProcessPerSite(content::BrowserContext* browser_context, const GURL& site_url);
  static bool ShouldUseSpareRenderProcessHost(content::BrowserContext* browser_context,
                                              const GURL& site_url);
  ...
  static bool CanCommitURL(content::RenderProcessHost* process_host,
                           const GURL& url);
  static bool IsSuitableHost(content::BrowserContext* browser_context,
  ...
  // Implements the extensions portion of content::ContentBrowserClient 
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_CHROME_CONTENT_BROWSER_CLIENT_EXTENSIONS_PART_H_
