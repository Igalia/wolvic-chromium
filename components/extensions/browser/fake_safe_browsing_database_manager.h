...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_FAKE_SAFE_BROWSING_DATABASE_MANAGER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_FAKE_SAFE_BROWSING_DATABASE_MANAGER_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_FAKE_SAFE_BROWSING_DATABASE_MANAGER_H_
