...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_CHROME_URL_REQUEST_UTIL_H_
#define COMPONENTS_EXTENSIONS_BROWSER_CHROME_URL_REQUEST_UTIL_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_CHROME_URL_REQUEST_UTIL_H_
