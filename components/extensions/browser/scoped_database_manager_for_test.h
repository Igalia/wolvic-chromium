...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_SCOPED_DATABASE_MANAGER_FOR_TEST_H_
#define COMPONENTS_EXTENSIONS_BROWSER_SCOPED_DATABASE_MANAGER_FOR_TEST_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_SCOPED_DATABASE_MANAGER_FOR_TEST_H_
