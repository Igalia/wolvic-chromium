...
#ifndef COMPONENTS_BROWSER_EXTENSIONS_CHROME_EXTENSIONS_BROWSER_CLIENT_H_
#define COMPONENTS_BROWSER_EXTENSIONS_CHROME_EXTENSIONS_BROWSER_CLIENT_H_
...
class ChromeExtensionsBrowserClient : public extensions::ExtensionsBrowserClient {
 public:
  class Delegate {
   public:
    virtual ~Delegate() = default;

    virtual EventRouterForwarder* extension_event_router_forwarder() = 0;
  ...
  void ReportError(content::BrowserContext* context,
                   std::unique_ptr<extensions::ExtensionError> error) override;
  ...
  void AttachExtensionTaskManagerTag(content::WebContents* web_contents,
                                     extensions::mojom::ViewType view_type) override;
  scoped_refptr<update_client::UpdateClient> CreateUpdateClient(
      content::BrowserContext* context) override;
  std::unique_ptr<extensions::ScopedExtensionUpdaterKeepAlive> CreateUpdaterKeepAlive(
      content::BrowserContext* context) override;
  ...
  bool HasIsolatedStorage(const extensions::ExtensionId& extension_id,
                          content::BrowserContext* context) override;
  ...
  void AddAdditionalAllowedHosts(
      const extensions::PermissionSet& desired_permissions,
      extensions::PermissionSet* granted_permissions) const override;
