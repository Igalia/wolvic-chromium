...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_CONSTANTS_H_
#define COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_CONSTANTS_H_
...
// not found.
extensions::Manifest::Type GetManifestType(const std::string& name);

}  // namespace schema_constants
}  // namespace components_extensions

#endif  // COMPONENTS_EXTENSIONS_BROWSER_EXTENSION_MANAGEMENT_CONSTANTS_H_
