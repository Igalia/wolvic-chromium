...
#include "components/extensions/browser/api/permissions/permissions_api_helpers.h"
...
using extensions::NetworkPermissionsUpdater;
...
using extensions::ScriptInjectionTracker;
...
namespace permissions = extensions::api::permissions;
