...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_INSTALL_SIGNER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_INSTALL_SIGNER_H_
...
class InstallSigner {
 public:
  ...
  InstallSigner(
      ...
      const extensions::ExtensionIdSet& ids);
  ...
  static extensions::ExtensionIdSet GetForcedNotFromWebstore();
 ...
 private:
  ...
  void HandleSignatureResult(const std::string& signature,
                             ...
                             const extensions::ExtensionIdSet& invalid_ids);
  ...
  extensions::ExtensionIdSet ids_;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_INSTALL_SIGNER_H_
