...
// mshin: Enable tests regardless a build flag
...
using extensions::ExtensionStateTester; 
...
// Extension is added to blocklist with extensions::BLOCKLISTED_POTENTIALLY_UNWANTED state
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest, GreylistedExtensionDisabled) {
  TestBlocklist test_blocklist;
  // A browser_context with 3 extensions installed: kGood0, kGood1, and kGood2.
  ...
  test_blocklist.SetBlocklistState(kGood0, extensions::BLOCKLISTED_CWS_POLICY_VIOLATION,
                                   true);
  test_blocklist.SetBlocklistState(kGood1, extensions::BLOCKLISTED_POTENTIALLY_UNWANTED,
                                   true);
  test_blocklist.SetBlocklistState("invalid_id", extensions::BLOCKLISTED_MALWARE, true);
  task_environment()->RunUntilIdle();
  ...
  ValidateIntegerPref(kGood0, "blacklist_state",
                      extensions::BLOCKLISTED_CWS_POLICY_VIOLATION);
  ValidateIntegerPref(kGood1, "blacklist_state",
                      extensions::BLOCKLISTED_POTENTIALLY_UNWANTED);
  ...
  test_blocklist.SetBlocklistState(kGood0, extensions::NOT_BLOCKLISTED, true);
  test_blocklist.SetBlocklistState(kGood1, extensions::NOT_BLOCKLISTED, true);
  task_environment()->RunUntilIdle();
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest, GreylistDontEnableManuallyDisabled) {
  ...
  test_blocklist.SetBlocklistState(kGood1, extensions::BLOCKLISTED_POTENTIALLY_UNWANTED,
                                   true);
  test_blocklist.SetBlocklistState(kGood2, extensions::BLOCKLISTED_SECURITY_VULNERABILITY,
                                   true);
  task_environment()->RunUntilIdle();
  ...
  test_blocklist.SetBlocklistState(kGood0, extensions::NOT_BLOCKLISTED, true);
  test_blocklist.SetBlocklistState(kGood1, extensions::NOT_BLOCKLISTED, true);
  test_blocklist.SetBlocklistState(kGood2, extensions::NOT_BLOCKLISTED, true);
  task_environment()->RunUntilIdle();
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest, GreylistUnknownDontChange) {
  ...
  test_blocklist.SetBlocklistState(kGood0, extensions::NOT_BLOCKLISTED, true);
  test_blocklist.SetBlocklistState(kGood1, extensions::BLOCKLISTED_UNKNOWN, true);
  test_blocklist.SetBlocklistState(kGood2, extensions::BLOCKLISTED_UNKNOWN, true);
  task_environment()->RunUntilIdle();
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest,
  ...
  SetBlocklistStateForExtension(kGood0, extensions::BLOCKLISTED_MALWARE, test_blocklist);
  ...
  SetBlocklistStateForExtension(kGood0, extensions::BLOCKLISTED_CWS_POLICY_VIOLATION,
                                test_blocklist);
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest,
  ...
  SetBlocklistStateForExtension(kGood0, extensions::NOT_BLOCKLISTED, test_blocklist);
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest,
  ...
  SetBlocklistStateForExtension(kGood0, extensions::BLOCKLISTED_POTENTIALLY_UNWANTED,
                                test_blocklist);
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest, AcknowledgedStateBackFilled) {
  ...
  blocklist_prefs::ClearAcknowledgedGreylistStates(
      kGood0, ExtensionPrefs::Get(browser_context()));
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest,
  ...
  service()->UninstallExtension(kGood0, extensions::UNINSTALL_REASON_FOR_TESTING, nullptr);
...
TEST_F(SafeBrowsingVerdictHandlerUnitTest,
  ...
  test_blocklist.SetBlocklistState(kGood0, extensions::BLOCKLISTED_MALWARE, true);
