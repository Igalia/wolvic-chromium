...
#include "components/extensions/browser/extension_prefs_unittest.h"
 ...
 public:
  ...
  void Initialize() override {
    ...
    syncer::StringOrdinal initial_ordinal =
        syncer::StringOrdinal::CreateInitialOrdinal();
    app_sorting()->SetPageOrdinal(extensions::kWebStoreAppId, initial_ordinal);
    app_sorting()->SetAppLaunchOrdinal(extensions::kWebStoreAppId, initial_ordinal);
  }
  void Verify() override {
    syncer::StringOrdinal page = app_sorting()->GetPageOrdinal(extensions::kWebStoreAppId);
