...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_STANDALONE_INSTALLER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_STANDALONE_INSTALLER_H_
...
#include "components/extensions/browser/webstore_data_fetcher_delegate.h"
#include "components/extensions/browser/webstore_install_helper.h"
#include "components/extensions/browser/webstore_installer.h"
#include "components/extensions/common/webstore_install_result.h"
...
class WebstoreStandaloneInstaller
 ...
 protected:
  ...
  scoped_refptr<const extensions::Extension> GetLocalizedExtensionForDisplay();
  ...
  const extensions::Extension* localized_extension_for_display() const {
 ...
 private:
  ...
  scoped_refptr<extensions::Extension> localized_extension_for_display_;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_STANDALONE_INSTALLER_H_
