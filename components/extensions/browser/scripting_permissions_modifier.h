...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_SCRIPTING_PERMISSIONS_MODIFIER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_SCRIPTING_PERMISSIONS_MODIFIER_H_
...
class ScriptingPermissionsModifier {
 public:
  ...
  std::unique_ptr<const extensions::PermissionSet> WithholdPermissionsIfNecessary(
      const extensions::PermissionSet& permissions);

 private:
  // Grants `explicit_hosts` and `scriptable_hosts` permissions. Calls
  // `done_callback` on completion.
  void GrantHostPermission(extensions::URLPatternSet explicit_hosts,
  ...
  // `done_callback` on completion.
  void WithholdHostPermissions(extensions::URLPatternSet explicit_hosts,
                               extensions::URLPatternSet scriptable_hosts,
                               base::OnceClosure done_callback);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_SCRIPTING_PERMISSIONS_MODIFIER_H_
