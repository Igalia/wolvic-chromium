...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_USER_SCRIPT_LISTENER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_USER_SCRIPT_LISTENER_H_
...
// TODO(mshin): Consider to support the mutiple profiles
class UserScriptListener : public extensions::ExtensionRegistryObserver {
 public:
  UserScriptListener();
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_USER_SCRIPT_LISTENER_H_
