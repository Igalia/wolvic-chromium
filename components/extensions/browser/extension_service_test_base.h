...
class ExtensionServiceTestBase : public testing::Test {
 ...
 protected:
  ...
  content::TestBrowserContext* testing_browser_context() { return browser_context_.get(); }
 ...
 protected:
  ...
  // The associated testing browser context.
 ...
 private:
  ...
  std::unique_ptr<TestContentBrowserClient> overriden_client_;
