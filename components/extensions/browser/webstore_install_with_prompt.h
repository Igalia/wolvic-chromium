...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALL_WITH_PROMPT_H_
#define COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALL_WITH_PROMPT_H_
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_WEBSTORE_INSTALL_WITH_PROMPT_H_
