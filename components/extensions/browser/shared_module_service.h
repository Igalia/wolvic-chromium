...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_SHARED_MODULE_SERVICE_H_
#define COMPONENTS_EXTENSIONS_BROWSER_SHARED_MODULE_SERVICE_H_
...
class SharedModuleService : public extensions::ExtensionRegistryObserver,
                            public InstallGate {
 public:
  enum ImportStatus {
    // No imports needed.
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_SHARED_MODULE_SERVICE_H_
