...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_INSTALL_VERIFIER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_INSTALL_VERIFIER_H_
...
class InstallVerifier : public KeyedService,
 ...
 public:
  InstallVerifier(extensions::ExtensionPrefs* prefs, content::BrowserContext* context);
  ...
  static bool NeedsVerification(const extensions::Extension& extension,
                                content::BrowserContext* context);

  // Determines if an extension claims to be from the webstore.
  static bool IsFromStore(const extensions::Extension& extension,
                          content::BrowserContext* context);
  ...
  void AddProvisional(const extensions::ExtensionIdSet& ids);

  // Removes an id or set of ids from the verified list.
  void Remove(const std::string& id);
  void RemoveMany(const extensions::ExtensionIdSet& ids);
 ...
 private:
  ...
  // verified.
  extensions::ExtensionIdSet GetExtensionsToVerify() const;
  ...
  void AddMany(const extensions::ExtensionIdSet& ids, OperationType type);
  ...
  extensions::ExtensionIdSet provisional_;
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_INSTALL_VERIFIER_H_
