...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_FORCED_EXTENSIONS_FORCE_INSTALLED_METRICS_H_
#define COMPONENTS_EXTENSIONS_BROWSER_FORCED_EXTENSIONS_FORCE_INSTALLED_METRICS_H_
...
class ForceInstalledMetrics : public ForceInstalledTracker::Observer {
 public:
  ForceInstalledMetrics(extensions::ExtensionRegistry* registry,
 ...
 private:
  ...
  // loaded.
  void ReportDisableReason(const extensions::ExtensionId& extension_id);
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_FORCED_EXTENSIONS_FORCE_INSTALLED_METRICS_H_
