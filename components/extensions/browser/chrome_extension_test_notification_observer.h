...
#ifndef COMPONENTS_EXTENSIONS_BROWSER_CHROME_EXTENSION_TEST_NOTIFICATION_OBSERVER_H_
#define COMPONENTS_EXTENSIONS_BROWSER_CHROME_EXTENSION_TEST_NOTIFICATION_OBSERVER_H_
...
class ChromeExtensionTestNotificationObserver
    : public extensions::ExtensionTestNotificationObserver,
...
#endif  // COMPONENTS_EXTENSIONS_BROWSER_CHROME_EXTENSION_TEST_NOTIFICATION_OBSERVER_H_
