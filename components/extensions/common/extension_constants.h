...
#ifndef COMPONENTS_EXTENSIONS_COMMON_EXTENSION_CONSTANTS_H_
#define COMPONENTS_EXTENSIONS_COMMON_EXTENSION_CONSTANTS_H_
...
// from //chrome/common/webui_url_constants.cc
...
inline constexpr char kChromeUIExtensionsInternalsHost[] = "extensions-internals";
inline constexpr char kChromeUIExtensionsInternalsURL[] = "chrome://extensions-internals";
