...
#ifndef COMPONENTS_EXTENSIONS_COMMON_MANIFEST_TESTS_CHROME_MANIFEST_TEST_H_
#define COMPONENTS_EXTENSIONS_COMMON_MANIFEST_TESTS_CHROME_MANIFEST_TEST_H_
...
#endif  // COMPONENTS_EXTENSIONS_COMMON_MANIFEST_TESTS_CHROME_MANIFEST_TEST_H_
