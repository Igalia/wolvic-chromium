...
#ifndef COMPONENTS_EXTENSIONS_COMMON_WEBSTORE_INSTALL_RESULT_H_
#define COMPONENTS_EXTENSIONS_COMMON_WEBSTORE_INSTALL_RESULT_H_
...
#endif  // COMPONENTS_EXTENSIONS_COMMON_WEBSTORE_INSTALL_RESULT_H_
