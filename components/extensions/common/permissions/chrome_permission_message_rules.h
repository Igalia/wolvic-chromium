...
#ifndef COMPONENTS_EXTENSIONS_COMMON_PERMISSIONS_CHROME_PERMISSION_MESSAGE_RULES_H_
#define COMPONENTS_EXTENSIONS_COMMON_PERMISSIONS_CHROME_PERMISSION_MESSAGE_RULES_H_
...
class ChromePermissionMessageFormatter {
 public:
  ...
  virtual extensions::PermissionMessage GetPermissionMessage(
      const extensions::PermissionIDSet& permissions) const = 0;
};
...
class ChromePermissionMessageRule {
 public:
  ...
  std::set<extensions::mojom::APIPermissionID> required_permissions() const;
  std::set<extensions::mojom::APIPermissionID> optional_permissions() const;
  std::set<extensions::mojom::APIPermissionID> all_permissions() const;

  extensions::PermissionMessage GetPermissionMessage(
      const extensions::PermissionIDSet& permissions) const;
 ...
 private:
  ...
  ChromePermissionMessageRule(
      int message_id,
      const std::initializer_list<extensions::mojom::APIPermissionID>& required,
      const std::initializer_list<extensions::mojom::APIPermissionID>& optional);
  ...
  std::set<extensions::mojom::APIPermissionID> required_permissions_;
  std::set<extensions::mojom::APIPermissionID> optional_permissions_;
...
#endif  // COMPONENTS_EXTENSIONS_COMMON_PERMISSIONS_CHROME_PERMISSION_MESSAGE_RULES_H_
