...
#ifndef WOLVIC_BROWSER_VSYNC_HELPER_H_
#define WOLVIC_BROWSER_VSYNC_HELPER_H_
...
class VSyncHelper {
 public:
  ...
  explicit VSyncHelper(Callback callback);

  VSyncHelper(const VSyncHelper&) = delete;
  VSyncHelper& operator=(const VSyncHelper&) = delete;
...
#endif  // WOLVIC_BROWSER_VSYNC_HELPER_H_
