...
public class ServiceWorkerPaymentAppBridge {
     ...
     */
     public static void hasServiceWorkerPaymentApps(WebContents paymentRequestWebContents,
        ...
        ServiceWorkerPaymentAppBridgeJni.get().hasServiceWorkerPaymentApps(paymentRequestWebContents, callback);
    }
     ...
     * @param callback The callback to return result.
     */
    public static void getServiceWorkerPaymentAppsInfo(WebContents paymentRequestWebContents,
        ...
        ServiceWorkerPaymentAppBridgeJni.get().getServiceWorkerPaymentAppsInfo(paymentRequestWebContents, callback);
    }
    ...
    @NativeMethods
    interface Natives {
        void hasServiceWorkerPaymentApps(WebContents paymentRequestWebContents, HasServiceWorkerPaymentAppsCallback callback);

      void getServiceWorkerPaymentAppsInfo(WebContents paymentRequestWebContents, GetServiceWorkerPaymentAppsInfoCallback callback);
